...
static void drawAboutAuthors(uint8_t arrow)
{
  ...
  spr.drawString("Modified by YO5PEI - ver. 1.0", 2, 70, 2);
  spr.drawString(AUTHORS_LINE1, 2, 70 + 16, 2);
  spr.drawString(AUTHORS_LINE2, 2, 70 + 16 * 2, 2);
  spr.drawString(AUTHORS_LINE3, 2, 70 + 16 * 3, 2);
  spr.drawString(AUTHORS_LINE4, 2, 70 + 16 * 4, 2);
  spr.pushSprite(0, 0);
}
