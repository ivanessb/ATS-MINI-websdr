...
// Added 20210218 - IU8LMN - Code for the "*.00 kHz" button
...
// Added 10 kHz steps 20210218 - IU8LMN -
...
//      if (freq<1800) steps=steps_am9; else steps=steps_am5;
    ...
    f=(st>0)?f:-f;
    if (iscw()) f-=(hi+lo)/2;
    // limit frequency when tuning to current band 20210218 - IU8LMN - 
    setfreq_lim(f);
   }
}
    // limit frequency when tuning to current band 20210218 - IU8LMN - 
...
{
    // Prevent from tuning out of currently-set band 20210218 - IU8LMN - 
	...
	f = bandinfo[band].centerfreq - (bandinfo[band].samplerate/2) - bandinfo[band].maxlinbw;
    //
    // prevent negative frequency from being set 20210218 - IU8LMN - 
    if(f<0) f = 0;
    //
    setfreq(f);
}
...
function keydown(e)
{
   ...
   switch (e.keyCode) {
      ...
      case 65: setmf ('am',  -3  ,  3  );    return cancelEvent(e);    // A
      case 70: setmf ('fm',  -3  ,  3  );    return cancelEvent(e);    // F
      case 67: setmf ('cw', -0.95, -0.55);   return cancelEvent(e);    // C
      case 76: setmf('lsb', -2.7, -0.15);     return cancelEvent(e);    // L
      case 85: setmf('usb',  0.15,  2.7);     return cancelEvent(e);    // U
...
function document_username()
{
  ...
  if (x) {
    ...
    document.write('<span id="please"><span id="please1"><b><i>Please log in by typing your callsign here (it will be saved for later visits in a cookie):<\/i><\/b></span> ');
...
function document_bandbuttons() {
    if (nvbands>1) {
       document.write("<br>Band Stacking Register")
       var i;
       for (i=0;i<nbands;i++) document.write ("<input style=\"display:none\" type=\"radio\" name=\"group0\" value=\""+bandinfo[i].name+"\" onclick=\"setband("+i+")\">"+bandinfo[i].name+"\n");
    }
}
...
// called by updates fetched from the server
{
  ...
  //Anti Spam Rule by IU8LMN
  var spam=s.toLowerCase();

  if (spam.includes("v.ht/")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("fr49.ru/")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked"}
  if (spam.includes("worty.co/")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("ruslekar.com/")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("радиомагазин")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("hamradio.top/")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("bit.ly/")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("PL-398BT")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("berlin")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("@@@band")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("PUTIN")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("Putin")) {s="🔴 Automated Spammer Detection activated! 👮 ABye bye spamdude ✅ User was kicked";}
  if (spam.includes("putin")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("BASTARD")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("Bastard")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("bastard")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("puttana")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("puttane")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("troia")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("troie")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("cazzo")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("cazzi")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("fica")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("culo")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("ricchione")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("frocio")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("bastardo")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("merda")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("uccido")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("ammazzo")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("zoccola")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("porco")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("prostituta")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("stronzo")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("stronza")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("stronzi")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("lesbica")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("bisex")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("pompino")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("pompini")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("terrone")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("terroni")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("polentone")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("polentoni")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("ladro")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("assassino")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("fessa")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("chiava")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("chiavati")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("chiavate")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("trombare")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("sparo")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("maiale")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("maiali")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("cornuto")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("cornuti")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("pucchiacca")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("trombato")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("pene")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("peni")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("membro")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("membri")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("vagina")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("uccidere")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("ammazzare")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("cafone")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("cafoni")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("cafoni")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("Stucazzu")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("mafia")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("camorra")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("ndrangheta")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("Schwuler")) {s="🔴 Automated Spammer Detection activated! 👮 Bye bye spamdude ✅ User was kicked";}
  if (spam.includes("☪ ")) {s="";}
  if (spam.includes("☾☆ ")) {s="";}  
  if (spam.includes("☪️")) {s="";} 
  if (spam.includes("schwuler")) {s="🔴 Automated Spammer Detection activated!👮 Bye bye spamdude ✅ User was kicked";} 
  if (spam.includes("::ffff")) {s="✖️ You must provide Name or Callsign to use the chatbox, message was not posted❗👮";}
  if (spam.includes(" ")) {s="✖️ You must provide Name or Callsign to use the chatbox, message was not posted❗👮";}
  if (spam.includes("unknown")) {s="✖️ You must provide Name or Callsign to use the chatbox, message was not posted❗👮";}  
  if ((spam.substring(10,11)) == ':') {s="✖️ You must provide Name or Callsign to use the chatbox, message was not posted❗👮";}
